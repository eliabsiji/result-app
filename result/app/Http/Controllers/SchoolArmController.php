...
class SchoolArmController extends Controller
{
    ...
    {
         $this->middleware('permission:school-arm-list|add-school-arm|edit-school-arm|delete-arm', ['only' => ['index','store']]);
         $this->middleware('permission:add-school-arm', ['only' => ['create','store']]);
         $this->middleware('permission:edit-school-arm', ['only' => ['edit','update']]);
         $this->middleware('permission:delete-school-arm', ['only' => ['destroy']]);
    }
