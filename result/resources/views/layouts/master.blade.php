...
<!-- Bootstrap Core and vandor -->
<link rel="stylesheet" href="{{ asset('assets/assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/assets/plugins/datatable/dataTables.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/assets/plugins/datatable/fixedeader/dataTables.fixedcolumns.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/assets/plugins/datatable/fixedeader/dataTables.fixedheader.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/assets/plugins/sweetalert/sweetalert.css')}}">
<link rel="stylesheet" href="{{ asset('assets/assets/plugins/summernote/dist/summernote.css')}}"/>
<link rel="stylesheet" href="{{ asset('assets/assets/plugins/dropify/css/dropify.min.css')}}">
...
<div id="main_content">
    ...
    <div id="header_top" class="header_top">
        <div class="container">
            <div class="hleft">
                <a class="header-brand" href="/dashboard"><i class="fa fa-graduation-cap brand-logo"></i></a>
                <div class="dropdown">
            ...
            <div class="hright">
                ...
                document.getElementById('logout-form').submit();" class="nav-link icon settingbar"><i class="fe fe-power"></i>
    ...
    <div class="user_div">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#righttab-Students">Staff</a></li>
                    ...
                    <div class="chat_windows">
                        <ul class="mb-0">
                            <li class="other-message">
                                <img class="avatar mr-3" src="{{ asset('assets/assets/images/xs/avatar1.jpg')}}" alt="avatar">
                                <div class="message">
                            ...
                            <li class="other-message">
                                ...
                                <div class="message">
                                    <div class="media_img">
                                        <img src="{{ asset('assets/assets/images/gallery/1.jpg')}}" class="w100 img-thumbnail" alt="">
                                        <img src="{{ asset('assets/assets/images/gallery/2.jpg')}}" class="w100 img-thumbnail" alt="">
                                    </div>
                                    <span class="time">10:15 AM, Today</span>
                                </div>
                            </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        Copyright © 2022 <a href="https://qudroidsystems.com">Qudriod Systems</a>.
                    </div>
...
<!-- Start all plugin js -->
<script src="{{ asset('assets/assets/bundles/counterup.bundle.js') }}"></script>
...
<script src="{{ asset('assets/assets/js/page/summernote.js') }}"></script>
<script src="{{ asset('assets/assets/js/page/dialogs.js') }}"></script>
<script src="{{ asset('assets/assets/js/table/datatable.js') }}"></script>
<script src="{{ asset('assets/assets/plugins/dropify/js/dropify.min.js')}}"></script>



<!-- Start Plugin Js -->
<script src="{{ asset('assets/assets/js/form/dropify.js') }}"></script>
<script src="{{ asset('assets/assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js') }}"></script>
<script src="{{ asset('assets/assets/bundles/dataTables.bundle.js') }}"></script>
<script src="{{ asset('assets/assets/plugins/sweetalert/sweetalert.min.js') }}"></script>
